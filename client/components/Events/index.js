...
class EventPage extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      (nextProps.subscribedClubs.indexOf(nextProps.club.id) !== -1)
    ) {
  ...
  unsubscribeThisEvent() {
    ...
    this.props
      ...
      .then(() => {
        toastr.warning(
          "You have unsubscribed. You will no longer get notifications on this event"
        );
                    ...
                    <div className="content">
                      <div className="event-details bordered">
                        ...
                        <ul className="member-list">
                          {attendees &&
                            attendees.map(attendee => (
                              <li key={attendee.user.app_user.id}>
                        ...
                        <div className="main-cta">
                          ...
                          {this.state.joinedEvent && (
                            <div onClick={this.unsubscribeThisEvent}>
